...
async function main() {
  ...
  const formImpuesto = await prisma.form.create({
    data: {
      ...
      description:
        "Plantilla para declaración de impuestos con lógica condicional (sí/no).",
      version: "1.0",
      active: true,
    },
  });
  ...
  await prisma.formField.createMany({
    data: [
      ...
      },
      {
        ...
        order: 1,
        rules: {
          showWhen: { field: "ingresos_independientes", value: true },
        } as any,
      },
      {
        formId: formImpuesto.id,
      ...
      },
      {
        ...
        order: 0,
        rules: {
          showWhen: { field: "propiedad_vivienda", value: true },
        } as any,
      },
      {
        formId: formImpuesto.id,
  ...
  await prisma.service.create({
    data: {
      ...
      description:
        "Full service preparation for Form 1040. Includes state filing.",
      price: 150.0,
      category: "TAX",
      steps: {
        create: [
  ...
  await prisma.service.create({
    data: {
      ...
      description:
        "Start your company legally. We handle state filing and EIN.",
      price: 300.0,
      category: "BUSINESS",
      steps: {
        create: [
          {
            ...
            formId: formBusinessDetails.id,
          },
          {
            orderIndex: 1,
            title: "Owner Information",
            description: "Who will own this business?",
            formId: formOwnerInfo.id,
          },
        ],
      },
      docTypes: {
        ...
        create: [
          {
            ...
            description: "Country of citizenship and passport.",
            formId: formApplicantInfo.id,
          },
        ],
      },
      docTypes: {
