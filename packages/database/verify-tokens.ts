...
async function main() {
    ...
    const emailPayload = { email: 'test@example.com', type: 'email_verification' };
    ...
    if (decryptedEmail && decryptedEmail.email === 'test@example.com' && decryptedEmail.type === 'email_verification') {
    ...
    if (decryptedReset && decryptedReset.sub === 'user-123-uuid' && decryptedReset.type === 'password_reset') {
