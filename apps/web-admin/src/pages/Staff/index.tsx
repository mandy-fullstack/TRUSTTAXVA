        ...
        <Layout>
            ...
            >
                <View style={styles.header}>
                    <View>
                        <H1 style={isMobile ? styles.titleMobile : undefined}>Staff & Team</H1>
                ...
                {staff.length === 0 ? (
                    <View style={styles.emptyState}>
                        ...
                        <Text style={styles.emptyText}>Staff members will appear here once they are added.</Text>
                    </View>
                ) : isMobile ? (
                                ...
                                <View style={styles.cardRow}>
                                    ...
                                    <View style={styles.cardMain}>
                                        <View style={styles.nameRow}>
                                            ...
                                            <Badge label={s.role} variant={s.role === 'ADMIN' ? 'primary' : 'secondary'} />
                                        </View>
                                        ...
                                        <View style={styles.cardMeta}>
                                            ...
                                            <Text style={styles.dateText}>Joined {new Date(s.createdAt).toLocaleDateString()}</Text>
                                        </View>
                                    </View>
                                </View>
                            </TouchableOpacity>
                        ...
                        {staff.map((s) => (
                            ...
                            >
                                ...
                                <View style={[styles.colDate, styles.cell]}>
                                    ...
                                    <Text style={styles.dateText}>{new Date(s.createdAt).toLocaleDateString()}</Text>
                                </View>
                            </TouchableOpacity>
                        ))}
                    </View>
