    ...
    return (
        <View style={styles.card}>
            ...
            <View style={styles.group}>
                ...
                <TextInput style={styles.input} value={data.companyName} onChangeText={(t) => onChange('companyName', t)} />
            </View>

            <View style={styles.group}>
                <Text style={styles.label}>Doing Business As (DBA)</Text>
                <TextInput style={styles.input} value={data.dba} onChangeText={(t) => onChange('dba', t)} />
            </View>

            <View style={styles.group}>
                <Text style={styles.label}>Description</Text>
                <TextInput style={[styles.input, styles.textArea]} value={data.description} onChangeText={(t) => onChange('description', t)} multiline />
            </View>
        </View>
    );
};
