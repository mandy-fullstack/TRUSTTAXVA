...
export const NotificationsPanel = ({
  ...
  const handleNotificationClick = (notification: any) => {
    ...
    handleClose();
    // Convert client routes to admin routes if needed
    let adminLink = notification.link;
    if (adminLink.startsWith("/dashboard")) {
      adminLink = adminLink.replace("/dashboard", "");
    }
    navigate(adminLink || "/dashboard");
  };
                  ...
                  {groupedNotifications.unread.length > 0 && (
                    <>
                      ...
                      >
                        ...
                        >
                          {t("notifications.unread_section")}
                        </p>
                      </div>
