        ...
        <View style={styles.container}>
            ...
            >
                {loading && messages.length === 0 ? (
                    ...
                    messages.map((msg) => {
                        // Admin is NOT CLIENT. So isMine is true if role !== CLIENT or if senderId matches admin id
                        // Usually admin role is ADMIN or PREPARER.
...
const styles = StyleSheet.create({
    ...
    bubbleLeft: { backgroundColor: '#FFFFFF', borderBottomLeftRadius: 4, borderWidth: 1, borderColor: '#E2E8F0' },
    ...
    input: { flex: 1, minHeight: 40, maxHeight: 100, backgroundColor: '#F8FAFC', borderRadius: 20, paddingHorizontal: 16, paddingVertical: 10, fontSize: 15, borderWidth: 1, borderColor: '#E2E8F0', outlineStyle: 'none' } as any,
