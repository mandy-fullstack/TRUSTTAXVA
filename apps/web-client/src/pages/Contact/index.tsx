  ...
  return (
    <PublicLayout>
      <PageMeta
        ...
        description={t(
          "contact.description",
          "Have questions? We're here to help. Get in touch with TrustTax for expert tax preparation, immigration services, and business consulting.",
        )}
      />
          ...
          <View style={styles.infoCol}>
            ...
            <Text style={styles.desc}>
              {t(
                ...
                "Fill out the form or reach us directly at the contact points below.",
              )}
            </Text>
            ...
            <View style={styles.contactItem}>
              ...
              <View>
                <Text style={styles.contactLabel}>
                  {t("contact.office", "Office")}
                </Text>
                <Text style={styles.contactValue}>
                  {profile?.address || "123 Business Ave, VA 22030"}
                </Text>
              </View>
            </View>
          </View>
