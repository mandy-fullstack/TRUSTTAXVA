  ...
  return (
    <PublicLayout>
      <PageMeta
        ...
        description={t(
          "services.subtitle",
          "Choose from our range of expert financial and legal services designed to help you succeed.",
        )}
      />
        ...
        <View style={styles.grid}>
          {filteredServices.length > 0 ? (
                  ...
                  <View style={styles.categoryBadgeRow}>
                    ...
                    <View style={styles.durationRow}>
                      ...
                      <Text style={styles.durationText}>
                        {t("common.days_estimated", "2-4 Days estimated")}
                      </Text>
                    </View>
                  </View>
            ...
            <View style={styles.emptyContainer}>
              ...
              <H3 style={{ marginTop: 16, color: "#0F172A" }}>
          ...
          <View style={styles.trustGrid}>
            <View style={styles.trustItem}>
              ...
              <Text style={styles.trustItemText}>
                Bank-level encryption for all your documents and personal data.
              </Text>
            </View>
            <View style={styles.trustItem}>
              <View style={styles.iconBox}>
              ...
              <Text style={styles.trustItemText}>
                Work with authorized CPAs and immigration experts.
              </Text>
            </View>
            <View style={styles.trustItem}>
              <View style={styles.iconBox}>
              ...
              <Text style={styles.trustItemText}>
                Get your filings done quickly without sacrificing accuracy.
              </Text>
            </View>
          </View>
        </View>
