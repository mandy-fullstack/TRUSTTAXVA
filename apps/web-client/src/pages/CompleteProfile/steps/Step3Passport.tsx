...
export const Step3Passport: React.FC<Step3PassportProps> = ({ onNext, onBack, initialData }) => {
    ...
    const handleNext = () => {
        if (!passportNumber || !passportCountry || !passportIssueDate || !passportExpiration) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>PASSPORT DETAILS</Text>
            </View>
            ...
            <View style={styles.form}>
                <Input
                    ...
                    style={error && !passportNumber ? { borderColor: '#EF4444' } : undefined}
                />
                ...
                <View style={[styles.group, { zIndex: 100 }]}>
                    ...
                    />
                    {!!error && !passportCountry && <Text style={{ color: '#EF4444', fontSize: 10, marginTop: 4, fontFamily: 'Inter' }}>REQUIRED</Text>}
                </View>

                <View style={[styles.row, { zIndex: 0, flexDirection: width < 600 ? 'column' : 'row' }]}>
                    <View style={{ flex: 1 }}>
                        <Input
                            label="ISSUED DATE"
                            ...
                            style={error && !passportIssueDate ? { borderColor: '#EF4444' } : undefined}
                        />
                    </View>
                    <View style={{ flex: 1 }}>
                        <Input
                            ...
                            placeholder="MM / DD / YYYY"
                            style={error && !passportExpiration ? { borderColor: '#EF4444' } : undefined}
                        />
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    photoBtnText: { fontSize: 14, fontWeight: '700', color: '#64748B', letterSpacing: 1, fontFamily: 'Inter' },
    ...
    backText: { fontSize: 12, fontWeight: '700', color: '#94A3B8', letterSpacing: 1, fontFamily: 'Inter' },
});
