...
export const Step3DriverLicense: React.FC<Step3DLProps> = ({
  onNext,
  onBack,
  initialData,
}) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>
          {t("profile_wizard.step3_dl.header", "DRIVER'S LICENSE DETAILS")}
        </Text>
      </View>

      <View style={styles.form}>
        <Input
          label={t("profile_wizard.step3_dl.number", "LICENSE NUMBER")}
          value={dlNumber}
        ...
        <View style={[styles.group, { zIndex: 100 }]}>
          <Text style={styles.label}>
            {t("profile_wizard.step3_dl.state", "ISSUING STATE")}
          </Text>
          <WizardStateSelect
            value={dlState}
            onChange={(val) => {
            ...
            placeholder={t(
              "profile_wizard.step3_dl.state_placeholder",
              "SELECT STATE",
            )}
          />
          {!!error && !dlState && (
        ...
        <View
          style={[
            styles.row,
            { flexDirection: width < 600 ? "column" : "row", zIndex: 0 },
          ]}
        >
          <View style={{ flex: 1 }}>
            <Input
              label={t("profile_wizard.step3_dl.issued", "ISSUED DATE")}
          ...
          <View style={{ flex: 1 }}>
            <Input
              label={t("profile_wizard.step3_dl.expiration", "EXPIRATION DATE")}
        ...
        >
          <View style={styles.photoHeader}>
            <Text style={styles.label}>
              {t(
                "profile_wizard.step3_dl.photo_label",
      ...
      <View style={styles.footer}>
        ...
        >
          {t("profile_wizard.step3_dl.proceed", "CONFIRM & PROCEED")}
        </Button>
