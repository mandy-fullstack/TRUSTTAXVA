...
export const Step3GovernmentID: React.FC<Step3Props> = ({ onNext, onBack, initialData }) => {
    ...
    const [country, setCountry] = useState(initialData?.passportCountryOfIssue || '');

    const isValid = idType === 'DL' ? dlNumber.length > 0 && dlState.length === 2 : passportNumber.length > 0;
    ...
    return (
        <View style={styles.container}>
            <View style={styles.typeSelector}>
                <TouchableOpacity
                    style={[styles.typeOption, idType === 'DL' && styles.typeOptionActive]}
                    onPress={() => setIdType('DL')}
                >
                    <Text style={[styles.typeText, idType === 'DL' && styles.typeTextActive]}>DRIVER LICENSE</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={[styles.typeOption, idType === 'PASSPORT' && styles.typeOptionActive]}
                    onPress={() => setIdType('PASSPORT')}
                >
                    <Text style={[styles.typeText, idType === 'PASSPORT' && styles.typeTextActive]}>PASSPORT</Text>
                </TouchableOpacity>
            </View>
