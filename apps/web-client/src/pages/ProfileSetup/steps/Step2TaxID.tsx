    ...
    return (
        <View style={styles.container}>
            <View style={styles.typeSelector}>
                <TouchableOpacity
                    style={[styles.typeOption, taxIdType === 'SSN' && styles.typeOptionActive]}
                    onPress={() => setTaxIdType('SSN')}
                >
                    <Text style={[styles.typeText, taxIdType === 'SSN' && styles.typeTextActive]}>SSN</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={[styles.typeOption, taxIdType === 'ITIN' && styles.typeOptionActive]}
                    onPress={() => setTaxIdType('ITIN')}
                >
                    <Text style={[styles.typeText, taxIdType === 'ITIN' && styles.typeTextActive]}>ITIN</Text>
                </TouchableOpacity>
            </View>
