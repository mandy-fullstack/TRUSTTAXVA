      ...
      >
        ...
        >
          ...
          <Text style={styles.backText}>
            {t("admin.back_to_orders", "Back to Orders")}
          </Text>
        </TouchableOpacity>
        ...
        <View style={styles.grid}>
            ...
            <Card style={styles.card}>
              ...
              <View style={styles.formGroup}>
                <Text style={styles.label}>
                  {t("admin.update_status", "Order Status")}
                </Text>
              ...
              <View style={styles.formGroup}>
                <View style={styles.labelRow}>
                  ...
                  <Text style={styles.label}>
                    {t("admin.admin_notes", "Internal Admin Notes")}
                  </Text>
                </View>
                <Input
                  multiline
            ...
            <Card style={styles.card}>
              ...
              {order.progress?.length > 0 ? (
                ...
                <Text style={styles.noData}>
                  {t("admin.no_progress_data", "No submission data available.")}
                </Text>
              )}
            </Card>
          ...
          <View style={styles.sideColumn}>
            ...
            <Card style={styles.card}>
              ...
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>
                  {t("admin.registered_since", "Client since")}
                </Text>
