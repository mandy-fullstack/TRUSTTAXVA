            ...
            <View style={styles.container}>
                <View style={styles.header}>
                    <View>
                        ...
                        <Text style={styles.subtitle}>{t('admin.services_subtitle', 'Manage service offerings, prices, and categories')}</Text>
                    </View>
                    <Button
                            ...
                            <View style={styles.cardContent}>
                                <View style={styles.serviceHeader}>
                                    <View style={styles.titleWrapper}>
                                        ...
                                        <Badge label={service.category} variant="info" style={styles.categoryBadge} />
                                    </View>
...
const styles = StyleSheet.create({
    ...
    actions: { flexDirection: 'row', borderTopWidth: 1, borderTopColor: '#F1F5F9', paddingTop: 16, gap: 16 },
