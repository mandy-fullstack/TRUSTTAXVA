        ...
        const fallbackReviews = [
          {
            ...
            author: "Sarah J.",
            rating: 5,
            text: "TrustTax made filing my taxes so easy. I just uploaded my docs and they handled everything. Got my refund faster than ever!",
            service: { name: "Tax Preparation" },
          },
          {
            id: "2",
            author: "Michael R.",
            rating: 5,
            text: "Professional, knowledgeable, and responsive. They helped me with my business formation and saved me a lot of headache.",
          ...
          },
          {
            ...
            author: "Elena G.",
            rating: 5,
            text: "Very happy with the immigration assistance. They were very clear about the process and kept me updated at every step.",
            service: { name: "Immigration Services" },
          },
        ];
                ...
                <View>
                  ...
                  {currentReview.service && (
                    <Text style={styles.serviceTag}>
                      {getServiceName(currentReview.service)}
                    </Text>
                  )}
                </View>
              </View>
