      ...
      <View style={styles.overlay}>
        <View style={styles.modal}>
          ...
          <Text style={styles.title}>
            {t("pin.setup_title", "Create Security PIN")}
          </Text>
          <View style={styles.descriptionRow}>
            <Text style={styles.description}>
              {step === "enter"
                ? t(
                    "pin.setup_step1_desc",
                    "Choose a 6-digit PIN to secure your sensitive actions.",
                  )
                : t("pin.setup_step2_desc", "Please confirm your new PIN.")}
            </Text>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              {t(
                "pin.usage_explanation",
                "This security PIN acts as a second layer of authentication for high-security actions.",
              )}
            </Text>
          </View>
          ...
          <Button
            ...
            disabled={
              isLoading ||
              (step === "enter" ? pin1.length !== 6 : pin2.length !== 6)
            }
            style={{ marginTop: 16 }}
          >
            {isLoading
