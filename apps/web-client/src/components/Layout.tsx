      ...
      <View style={styles.container}>
          ...
          >
            ...
            {isAuthenticated && (
              ...
              >
                <User
                  size={20}
                  color={isActive("/dashboard/profile") ? "#2563EB" : "#64748B"}
                />
                <Text
                  style={[
                    styles.navLabel,
                    isActive("/dashboard/profile") && styles.navLabelActive,
                    styles.mobileNavText,
                  ]}
                >
          ...
          {noScroll ? (
            ...
            <ScrollView
              style={[
                ...
                isChatOpen && !isMobile && { marginRight: 0 },
              ]}
        ...
        {isAuthenticated && !isChatOpen && !isChatPage && (
          ...
          >
            ...
            {notifications.filter((n) => n.type === "message" && !n.read)
              .length > 0 && (
              <View style={styles.badge}>
                <Text style={styles.badgeText}>
                  {
