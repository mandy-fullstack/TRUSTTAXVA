...
export const ChatWidget = ({ onClose }: ChatWidgetProps) => {
  ...
  const handleOrderInquiry = (order: any) => {
    const subject = t("chat.order_inquiry_subject", {
      ...
      {selectedId ? (
            ...
            >
              ...
              <View>
                <Text style={styles.orderTitle}>
                  Orden #{order.displayId || order.id.slice(0, 8)}
                </Text>
        ...
        <View style={styles.listContainer}>
          ...
          <View style={styles.actionsGrid}>
            ...
            <TouchableOpacity
              style={styles.actionCard}
              onPress={() => handleCreateConversation(t("chat.profile_help"))}
            >
              <View style={styles.actionIcon}>
