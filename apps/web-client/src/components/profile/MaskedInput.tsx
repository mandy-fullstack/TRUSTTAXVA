...
export const MaskedInput = ({
  ...
  const [originalDecryptedValue, setOriginalDecryptedValue] = useState<
    string | null
  >(null);
  ...
  const hasUnsavedChanges =
    hasValue &&
    (!hasStoredValue || maskValue(value, maskType) !== maskedDisplay);
        ...
        <TextInput
          ...
          onEndEditing={(e) => {
            ...
            if (isEmpty) {
              ...
              originalDecryptedValue &&
              currentValue === originalDecryptedValue
            ) {
              setOriginalDecryptedValue(null);
              setIsEditing(false);
            } else {
