  ...
  return (
    <View style={styles.wrapper}>
      <View style={styles.header}>
        <Text style={styles.label}>{t("profile.passport", "Passport")}</Text>
        <TouchableOpacity
      ...
      {showWhy && (
        <View style={styles.whyBox}>
          ...
          <Text style={styles.whyBody}>
            {t(
              "profile.why_passport_body",
              "We use your passport number, country of issue, and expiration date for identity verification in immigration-related tax services and IRS compliance. All data is encrypted with AES-256-GCM before storage. We never display the full passport number.",
            )}
          </Text>
        </View>
      )}
      ...
      <View style={styles.row}>
              ...
              onLoadDecrypted
                ? async () => {
                    ...
                    if (decrypted) {
                      ...
                      onCountryChange(
                        (decrypted.countryOfIssue || "").toUpperCase(),
                        "",
                      );
                      onExpirationChange(
        ...
        <View style={[styles.group, { flex: 1 }]}>
          <Text style={styles.sublabel}>
            {t("profile.passport_country", "Country of issue")}
          </Text>
          <CountrySelect
