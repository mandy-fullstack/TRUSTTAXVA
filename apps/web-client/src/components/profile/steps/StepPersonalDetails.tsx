...
export const StepPersonalDetails = ({ data, onChange, errors, clearError }: StepPersonalDetailsProps) => {
            ...
            <View style={styles.complianceAlert}>
                ...
                <View style={styles.alertContent}>
                    ...
                    <Text style={styles.alertText}>
                        {t('profile.legal_compliance_text', 'The information provided below will be used for official tax filings and legal documentation. It must match your government-issued ID exactly. Incorrect information may result in processing delays or penalties.')}
                    </Text>
                </View>
            </View>
                ...
                <View style={styles.formRow}>
                    <View style={[styles.formGroup, { flex: 1, minWidth: 200 }]}>
                        <CountrySelect
                            ...
                            onChange={(v) => handleChange('countryOfBirth', (v || '').toUpperCase())}
