    ...
    <View style={styles.container}>
      <View style={styles.intro}>
        <Text style={styles.introText}>
          {t(
            "profile.legal_docs_intro",
            "Please provide details from your official identification documents. This helps us verify your identity and facilitates accurate tax filing.",
          )}
        </Text>
      </View>
      ...
      <Card style={styles.card}>
        ...
        <ProfileDriverLicense
          ...
          onNumberChange={(v) =>
            handleChange("driverLicenseNumber", (v || "").toUpperCase())
          }
          ...
          onExpirationChange={(v) =>
            handleChange("driverLicenseExpiration", (v || "").toUpperCase())
          }
      ...
      <Card style={styles.card}>
        ...
        <ProfilePassport
          ...
          onNumberChange={(v) =>
            handleChange("passportNumber", (v || "").toUpperCase())
          }
          onCountryChange={(code) =>
            handleChange("passportCountryOfIssue", (code || "").toUpperCase())
          }
          onExpirationChange={(v) =>
            handleChange("passportExpiration", (v || "").toUpperCase())
          }
