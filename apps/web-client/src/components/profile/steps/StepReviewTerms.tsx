...
export const StepReviewTerms = ({
  data,
  errors,
  onShowTerms,
}: StepReviewTermsProps) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.summaryContainer}>
        <H3 style={styles.summaryTitle}>
          {t("profile.review_summary", "Profile Summary")}
        </H3>
        <View style={styles.summaryGrid}>
          <View style={styles.summaryItem}>
            <Text style={styles.summaryLabel}>
              {t("profile.full_name", "Legal Name")}
            </Text>
          ...
          <View style={styles.summaryItem}>
            <Text style={styles.summaryLabel}>
              {t("profile.tax_id_type", "Tax ID Type")}
            </Text>
            <Text style={styles.summaryValue}>{data.taxIdType}</Text>
          </View>
          <View style={styles.summaryItem}>
            <Text style={styles.summaryLabel}>
              {t("profile.primary_language", "Language")}
            </Text>
            <Text style={styles.summaryValue}>
              {data.primaryLanguage?.toUpperCase()}
            </Text>
          </View>
        </View>
      </View>
      ...
      <Card style={styles.card}>
        ...
        <View>
          ...
          >
            ...
            <View style={styles.termsText}>
              ...
              <TouchableOpacity onPress={onShowTerms} activeOpacity={0.7}>
        ...
        <Text style={styles.termsNote}>
          {t(
            "profile.terms_note",
            "By accepting, you acknowledge that your SSN/ITIN, driver's license, and passport data will be encrypted and protected according to our security standards.",
          )}
        </Text>
