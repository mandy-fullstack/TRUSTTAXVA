...
export const AlertDialog = ({
    ...
    const displayButtons = buttons || [{ text: buttonText || t('dialog.ok', 'OK'), onPress: onClose }];
                    ...
                    {displayButtons.map((btn, idx) => (
                        <TouchableOpacity
                            ...
                            style={[
                                ...
                                btn.style === 'cancel' && { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0' },
                        ...
                        >
                            <Text style={[
                                ...
                                (!btn.style || btn.style === 'destructive') && { color: '#FFFFFF' },
                            ]}>
                                {btn.text}
                            </Text>
                        </TouchableOpacity>
