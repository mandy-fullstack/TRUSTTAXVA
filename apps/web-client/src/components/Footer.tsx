                ...
                <View style={styles.footerMain}>
                    ...
                    <View style={styles.brandSection}>
                        ...
                        <View style={styles.socialGrid}>
                            {social.facebook && <TouchableOpacity onPress={() => openLink(social.facebook)} style={styles.socialBox}><Facebook size={16} color="#94A3B8" /></TouchableOpacity>}
                            {social.instagram && <TouchableOpacity onPress={() => openLink(social.instagram)} style={styles.socialBox}><Instagram size={16} color="#94A3B8" /></TouchableOpacity>}
                            {social.linkedin && <TouchableOpacity onPress={() => openLink(social.linkedin)} style={styles.socialBox}><Linkedin size={16} color="#94A3B8" /></TouchableOpacity>}
                            {social.twitter && <TouchableOpacity onPress={() => openLink(social.twitter)} style={styles.socialBox}><Twitter size={16} color="#94A3B8" /></TouchableOpacity>}
                        </View>
                    </View>
                    ...
                    <View style={styles.navSection}>
                        ...
                        <View style={styles.navCol}>
                            <Text style={styles.colHeader}>{t('footer.reach_out', 'Reach Out')}</Text>
                            ...
                            {hoursList.length > 0 && (
                                <View style={styles.hoursCompact}>
                                    {hoursList.map((h: any, i: number) => (
                                        <Text key={i} style={styles.hoursSmall}>{h.label}: {h.value}</Text>
                                    ))}
                                </View>
                            )}
                        </View>
                        ...
                        <View style={[styles.navCol, styles.complianceCol]}>
                            <Text style={styles.colHeader}>{t('footer.compliance', 'Compliance')}</Text>
                ...
                <View style={styles.footerBottom}>
                    <View style={styles.footerBottomInner}>
                        <Text style={styles.copyrightText}>
                            &copy; {new Date().getFullYear()} {companyName}. {t('footer.rights_reserved', 'All rights reserved.')}
                        </Text>
                        <View style={styles.legalLinks}>
                            <TouchableOpacity><Text style={styles.legalText}>{t('footer.privacy_policy', 'Privacy Policy')}</Text></TouchableOpacity>
                            <View style={styles.legalDot} />
                            <TouchableOpacity><Text style={styles.legalText}>{t('footer.terms_of_service', 'Terms of Service')}</Text></TouchableOpacity>
                        </View>
                    </View>
                </View>
            </View>
