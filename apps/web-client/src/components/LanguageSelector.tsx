...
export const LanguageSelector = ({ variant = 'desktop', showChevron = true }: LanguageSelectorProps) => {
    ...
    return (
        <TouchableOpacity
            ...
            activeOpacity={0.7}
            aria-label={t('header.switch_language', 'Switch language')}
        >
            <FlagIcon lang={i18n.language} />
            <Text style={[isMobile ? styles.mobileText : styles.desktopText, { color: isMobile ? primaryColor : '#0F172A' }]}>
