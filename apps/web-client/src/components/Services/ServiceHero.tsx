        ...
        <View style={styles.hero}>
            ...
            <Card style={styles.priceCard} elevated>
                ...
                <View style={styles.priceContainer}>
                    ...
                    <H1 style={styles.priceValueDetail}>${service.price ? Number(service.price).toFixed(0) : '0'}</H1>
                </View>
...
const styles = StyleSheet.create({
    ...
    ratingSummary: { flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 8 },
    ...
    priceHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
    priceLabel: { fontSize: 12, fontWeight: '700', color: '#64748B', textTransform: 'uppercase' },
    priceContainer: { flexDirection: 'row', alignItems: 'baseline', gap: 12, marginBottom: 12 },
    originalPrice: { fontSize: 20, color: '#94A3B8', textDecorationLine: 'line-through', fontWeight: '400' },
    priceValueDetail: { color: 'var(--secondary-color, #0F172A)', fontSize: 40, fontWeight: '800' } as any,
    durationRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
    durationText: { fontSize: 14, color: '#64748B' },
    guarantee: { fontSize: 12, color: '#10B981', fontWeight: '600', textAlign: 'center', marginTop: 12 },
