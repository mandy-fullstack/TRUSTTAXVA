...
function getDefaultCategories(t: (key: string) => string): DocumentCategory[] {
  return [
    {
      title: t("services.documents.identification"),
      items: [
        t("services.documents.valid_passport"),
        t("services.documents.ssn_itin"),
      ],
    },
    {
      title: t("services.documents.income_documents"),
      items: [
        t("services.documents.w2_forms"),
        t("services.documents.1099_forms"),
        t("services.documents.business_income"),
      ],
    },
    {
      title: t("services.documents.deductions_credits"),
      items: [
        t("services.documents.mortgage_interest"),
        t("services.documents.educational_expenses"),
        t("services.documents.medical_expenses"),
      ],
    },
    {
      title: t("services.documents.previous_returns"),
      items: [
        t("services.documents.prior_returns"),
        t("services.documents.state_tax"),
        t("services.documents.amendment_forms"),
      ],
    },
  ];
}
