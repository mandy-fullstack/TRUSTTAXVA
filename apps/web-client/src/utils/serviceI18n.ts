...
export function getServiceName(service: Service): string {
    ...
    if (service.nameI18n) {
        return service.nameI18n[lang] || service.nameI18n.en || service.nameI18n.es || service.name || '';
    }
    return service.name || '';
}
...
export function getServiceDescription(service: Service): string {
    ...
    if (service.descriptionI18n) {
        return service.descriptionI18n[lang] || service.descriptionI18n.en || service.descriptionI18n.es || service.description || '';
    }
